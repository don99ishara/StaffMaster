...
<body>
	...
	<h1>Update Staff Details</h1>
        ...
        <input type="text" name="fname" id="fname" value="<%=fname %>" required><br><br>

        <label for="last_name">Last Name:</label>
        <input type="text" name="lname" id="lname" value="<%=lname %>" required><br><br>

        <label for="nic">NIC number:</label>
        <input type="text" name="nic" id="nic" value="<%= NIC %>" required><br><br>
        ...
        <input type="tel" name="phone" id="phone" value="<%=mobile %>" required><br><br>

        <label for="address">Address:</label>
        <textarea name="address" id="address" rows="4" required><%=address %></textarea><br><br>
        ...
        <input type="password" name="confirm_password" id="confirm_password" value="<%=password %>" required><br><br>
