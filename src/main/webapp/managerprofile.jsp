...
<head>
    <meta charset="UTF-8">
    <title>Staff Manager Information</title>
    <style>
        body {
...
<div class="menu-bar">
    <div class="user-profile-buttons">
        ...
        <a href="allnotices"><button class="menu-button" onclick="">Notices</button></a>
        <a href="createNotice.jsp"><button class="menu-button" onclick="">Create A Notice</button></a>
