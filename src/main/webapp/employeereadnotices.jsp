    ...
    <style>
        ...
        .topic {
 			...
 			color: white; /* Set the font color to white */
  			font-family: cursive; /* Replace 'Your Unique Font' with the font you want to use */
 			/* You may need to specify a backup font-family for cross-browser compatibility */
		}
