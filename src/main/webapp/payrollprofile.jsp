...
<div class="menu-bar">
        ...
        <h1 class="stopic">Staff Master</h1>
            <a href="disall"><button class="menu-button" onclick="">Update Salary</button></a>
            <a href="disbudget"><button class="menu-button" onclick="">Budgets</button></a>
            <button class="menu-button" onclick="">Complain !</button>
            <a href="employeeviewnotices"><button class="menu-button" onclick="">Notices</button></a>
